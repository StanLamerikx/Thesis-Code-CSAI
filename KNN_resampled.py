...
df_mitbih_train = X_train_mitbih.copy()
...
X_train_mitbih_resampled = df_mitbih_resampled.iloc[:, :-1]
y_train_mitbih_resampled = df_mitbih_resampled['label'].values

# Extract features for KNN classifier
train_features_mitbih = extract_features(X_train_mitbih_resampled)
...
classifier_mitbih.fit(train_features_mitbih, y_train_mitbih_resampled)
...
# Create a DataFrame for resampling
df_ptbdb_train = X_train_ptbdb.copy()
df_ptbdb_train['label'] = y_train_ptbdb

# Resample to balance classes in PTBDB
...
# Extract features and labels after resampling
X_train_ptbdb_resampled = df_ptbdb_resampled.iloc[:, :-1]
y_train_ptbdb_resampled = df_ptbdb_resampled['label'].values

# Extract features for KNN classifier
train_features_ptbdb = extract_features(X_train_ptbdb_resampled)
...
classifier_ptbdb.fit(train_features_ptbdb, y_train_ptbdb_resampled)
